...
if __name__=="__main__":
 ...
 for particleEnergy in ([20] if particle=="Electron" else [5]): #[2,3,4,5,6,7,8,9,10] # CERN stack
  ...
  ("Digi_data_integral",0,50000,200,"DetIdHGCSampleHGCDataFramesSorted_mix_HGCDigisHEback_GENSIMDIGIRECO","data","ADC count sum per event","Fraction of events"),
  ...
  ("Digi_data_integral_in_layer"+str(l),0,10000,200,"DetIdHGCSampleHGCDataFramesSorted_mix_HGCDigisHEback_GENSIMDIGIRECO","data","ADC count sum per layer","Fraction of events"),
